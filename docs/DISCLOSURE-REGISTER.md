...
| Arrival estimate on saved trips | 2 | Generated by a MockEtaProvider and labelled "demo estimate" everywhere it renders. The real arrival prediction is Spine 1 of the AI layer and is not built yet. Nothing on screen claims a live prediction. |
